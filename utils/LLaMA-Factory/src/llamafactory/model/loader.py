...
from .hdlm_utils.hdlm_depth2 import Depth2_HdLMModel
from .hdlm_utils.hdlm_depth3 import Depth3_HdLMModel
    ...
    if model is None and not lazy_load:
        ...
        if model_args.mixture_of_depths == "load":
            ...
            model = Depth3_HdLMModel.from_pretrained(**init_kwargs,
                                                   ...
                                                   final_loss_weight = model_args.final_loss_weight,
                                                   first_loss_weight = model_args.first_loss_weight,
                                                   second_loss_weight = model_args.second_loss_weight,
                                                   record_losses = True)
        else:
